...
%     debug_visual_msg.arrow_directions(3) = 30;
    ...
    debug_visual_msg.arrow_base_positions(1)= grf(i,1);
    debug_visual_msg.arrow_base_positions(2)= grf(i,2);
    debug_visual_msg.arrow_base_positions(3)= grf(i,3)/100;
    debug_visual_msg.arrow_directions(1) = grf(i,4)*100;
    debug_visual_msg.arrow_directions(2) = grf(i,5)*100;
    debug_visual_msg.arrow_directions(3) = grf(i,6)*100;
    debug_visual_msg.arrow_base_positions(4)= grf(i,7);
    debug_visual_msg.arrow_base_positions(5)= grf(i,8);
    debug_visual_msg.arrow_base_positions(6)= grf(i,9)/100;
    debug_visual_msg.arrow_directions(4) = grf(i,10)*100;
    debug_visual_msg.arrow_directions(5) = grf(i,11)*100;
    debug_visual_msg.arrow_directions(6) = grf(i,12)*100;
